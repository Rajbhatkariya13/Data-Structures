//approach one when it comes to, whether the success of push and pop
//here we are just retuning 0 and 1, for the indication that the push has been successfully pushed into the stack;
#include<stdio.h>
#include<string.h>
#include<stdlib.h>
